...
describe('ES6 ', function () {
    ...
    describe('Arrow function', function () {
        describe('Invoked through call or apply', function () {
            it('Should not bind this through call', function () {
                var person = {
                    age: 1,
                    add: function add(age) {
                        var _this = this;
                    ...
                    addThruCall: function addThruCall(age) {
                        var _this2 = this;
                    ...
                    addThruApply: function addThruApply(age) {
                        var _this3 = this;
                ...
                var actual = person.add(1);

                (0, _chai.expect)(actual).equal(__);
        ...
        describe('Used as methods', function () {
            it('Should return undefined', function () {
                var person = {
                    ...
                    getAgeByArrow: function getAgeByArrow() {
                        return undefined ? undefined.age : undefined;
                    }
                };
    ...
    describe('Class in ES6', function () {
        describe('Like a function ...', function () {
            // Declare the Human class below that will satisfy all assertions
            var Human = void 0;
            it('should be a function', function () {
                (0, _chai.expect)(Human).to.be.a('function');
            });
            it('should not be hoisted like function', function () {
                var polyFunc = void 0;
                ...
                var actual = polyFunc.log();

                (0, _chai.expect)(actual).equal('H:3 & W:5');

                var polyClass = void 0;
                ...
                var PolygoneClass = function () {
                    function PolygoneClass(height, width) {
                        _classCallCheck(this, PolygoneClass);

                        this.height = height;
                        this.width = width;
                    }

                    _createClass(PolygoneClass, [{
                        key: 'log',
                        value: function log() {
                            return 'H:' + this.height + ' & W:' + this.width;
                        }
    ...
    describe('Destructuring', function () {
        describe('Object', function () {
            ...
            it('With ES6 object Destructuring to do the same operation', function () {
                // TODO Extract the required information using the spread operator.
                (0, _chai.expect)(id).to.be.defined;
                (0, _chai.expect)(fullName).to.equal('Davy Engone');
                (0, _chai.expect)(twitter).to.equal('davyengone');
            });
        });

        describe('Array', function () {
            var fruits = ['brussels sprout', 'apple', 'beetroot', 'broccoli', 'carrot', 'cherry'];

            it('With ES5', function () {
                var first = fruits[0];
                (0, _chai.expect)(first).to.equal('brussels sprout');
                var last = fruits[fruits.length - 1];
                (0, _chai.expect)(last).to.equal('cherry');
            });

            it('With ES6', function () {
                // TODO: Get the first fruit
                var actual = void 0;
                (0, _chai.expect)(actual).to.equal('brussels sprout');
                // TODO: Get the last fruit
                (0, _chai.expect)(actual).to.equal('cherry');
                // TODO: Get the queue fruit;
                (0, _chai.expect)(actual).deep.equal(['apple', 'beetroot', 'broccoli', 'carrot', 'cherry']);
            });
        });
    });
    ...
    describe('Default parameters', function () {
        it("With ES5", function () {
            ...
            var actual = drawES5Chart({
                cords: { x: 18, y: 30 },
                radius: 30
            });
            (0, _chai.expect)(actual).deep.equal(['big', { x: 18, y: 30 }, 30]);
        });
        it("With ES6", function () {
            ...
            var actual = drawES6Chart();
            (0, _chai.expect)(actual).deep.equal(['big', { x: 0, y: 0 }, 25]);
