...
describe('Basic javascript tests', function () {
    it('equality with type coercion', function () {
        (0, _chai.expect)(3).equal('__');
    });
    it('string.length', function () {
        var fruit = 'apple';
        (0, _chai.expect)(__).equal(fruit.length);
    });

    it('slice', function () {
        var fruit = 'apple pie';
        (0, _chai.expect)(__).equal(fruit.slice(0, 5));
    });
    it('typeof', function () {
        (0, _chai.expect)(__).equal(_typeof({}));
        (0, _chai.expect)(__).equal(_typeof('apple'));
        (0, _chai.expect)(__).equal(_typeof(-5));
        (0, _chai.expect)(__).equal(_typeof(false));
    });
    describe('About Objects', function () {
        it('object literal notation', function () {
            ...
            (0, _chai.expect)('Amory Blaine').equal(person.name);
            (0, _chai.expect)(102).equal(person.age);
        });
        ...
        it('adding functions', function () {
            ...
            (0, _chai.expect)('I Amory Blaine am 102 years old.').equal(person.toString());
        });
    });
    ...
    it('variables declared inside of a function', function () {
        ...
        (function () {
            ...
            (0, _chai.expect)(__).equal(outerVariable);
            (0, _chai.expect)(__).equal(innerVariable);
        })();

        (0, _chai.expect)(__).equal(outerVariable);
        (0, _chai.expect)(__).equal(typeof innerVariable === 'undefined' ? 'undefined' : _typeof(innerVariable));
    });
});
