...
describe("Advanced JS", function () {
    describe("JS falsy values", function () {
        it("List all the falsy values in JavaScript", function () {
            var falsy = __;
            (0, _chai.expect)(falsy).to.not.be.ok;
            falsy = __;
            (0, _chai.expect)(falsy).to.not.be.ok;
            falsy = __;
            (0, _chai.expect)(falsy).to.not.be.ok;
    ...
    describe("About functions", function () {
        it("should declare function: add", function () {
            (0, _chai.expect)(add(1, 2)).to.equal(__);
        });
        ...
        it("should know internal variables override outer variables", function () {
            ...
            (0, _chai.expect)(getMessage()).to.equal(__);
            (0, _chai.expect)(overrideMessage()).to.equal(__);
            (0, _chai.expect)(message).to.equal(__);
        });
        ...
        it("should allow extra function arguments", function () {
            ...
            (0, _chai.expect)(returnFirstArg("first", "second", "third")).to.equal(__);

            function returnSecondArg(firstArg, secondArg) {
                return secondArg;
            }

            (0, _chai.expect)(returnSecondArg("arguments")).to.equal(__);

            // TODO: Fix the function to return all arguments.
            function returnAllArgs() {}

            (0, _chai.expect)(returnAllArgs("first", "second", "third")).to.equal(__);
        });
    });

    describe("Context in JavaScript", function () {
        describe("Should use bind", function () {

            it("push a new user after 0,5s", function (done) {
                var hackcamp = {
                    members: ["Davy"]
                };
                ...
                function addMembers() {
                    ...
                    (0, _chai.expect)(this.members.length).equal(2);
                    done();
                }
        ...
        describe('What does "this" refer to ?', function () {
            function addMentor(mentor) {
                this.mentors.push(mentor);
                return this.mentors;
            }

            it("Should add new mentor ", function () {
                var company = {
                    name: "Hackages Lab",
                    addMentor: addMentor
                };
                var actual = company.addMentor("Juan");

                (0, _chai.expect)(actual).to.be.deep.equal(["Alex", "Juan"]);
            });
        });
    });
});
